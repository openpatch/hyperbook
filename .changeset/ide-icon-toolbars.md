...
The remaining directive icons became SVG as well: the fullscreen buttons in **webide** and **typst**, the download icons in **download** and **archive**, the lock in **protect**, typst's add-file button, and the expand arrows on the binary-file sections of **openscad** and **typst**.
