...
| assets.cdn         | Lade die Stile und Skripte der Elemente von einem CDN, statt sie in deinen Build zu kopieren. `true` nutzt jsDelivr, festgelegt auf die Version, die dein Hyperbook gebaut hat. Eine URL nutzt einen eigenen Spiegel. Ein so ausgeliefertes Hyperbook braucht das Netz. |
