...
function collect(root, basePath, label, icon) {
  return __async(this, null, function* () {
    ...
    if (hyperbookJson) {
      let href =
        (_a = basePath != null ? basePath : hyperbookJson.basePath) != null
          ? _a
          : "/";
      if (!href.startsWith("/")) {
        href = "/" + href;
    ...
    const hyperlibraryJson = yield fs
          ...
          __async(
            ...
            function* ({ src, basePath: localBasePath, name, icon: icon2 }) {
              ...
              return collect(
                ...
                path.join(
                  (_a2 =
                    basePath != null ? basePath : hyperlibraryJson.basePath) !=
                    null
                    ? _a2
                    : "",
                  localBasePath
...
var require_src = __commonJS({
  "src/index.ts"(exports) {
    init_project();
    var createNextApp = (root, basePath) =>
    ...
    var handleProject = (server) => (project) =>
      __async(exports, null, function* () {
