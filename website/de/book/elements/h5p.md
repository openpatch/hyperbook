...
| -------------- | ------------------------------------------------------------------------------ | --------------------------------- |
| `src`          | Pfad zur H5P-Datei                                                             | -                                 |
| `export`       | Zeigt die Reuse-Schaltfläche zum Herunterladen der ursprünglichen H5P-Datei an | `false`                           |
| `download-url` | Alternativer Pfad oder URL für die heruntergeladene Datei                      | Die ursprüngliche Datei aus `src` |
...
Mit dem `export`-Attribut können Leserinnen und Leser die ursprüngliche
`.h5p`-Datei herunterladen und wiederverwenden.

Verwende `download-url`, wenn das herunterladbare Paket unter einer anderen URL
liegt.
